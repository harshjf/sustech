            ...
            <div className="row">
              ...
              <div className="content-column col-xl-5 col-lg-6 col-md-12 col-sm-12 order-lg-2 wow fadeInRight">
                <div className="inner-column">
                  ...
                  <Link href="page-contact" className="theme-btn btn-style-one"><span className="btn-title">Contact Us <i className="icon icon-sm-arrow"></i></span></Link>
                </div>
              </div>
              ...
              <div className="image-column col-xl-7 col-lg-6 col-md-12 col-sm-12">
                <div className="inner-column">
                  <div className="image-box">
                    ...
                    <figure className="image-2 overlay-anim" data-wow-delay="300ms"><img src="/images/resource/about3-2.jpg" alt="Image"/></figure>
