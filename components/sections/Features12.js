...
const Features12 = () => {
    return (
        ...
        <section className="features-section-two">
          <div className="float-image"><img src="/images/resource/float-img.png" alt="Image"/></div>
                  ...
                  <div className="row">
                    ...
                    <div className="feature-block-two col-md-6 wow fadeInUp">
                      <div className="inner-box">
                        ...
                        <div className="content">
                          <h6 className="title"><Link href="page-services">The one-stop smart <br/> solar solution.</Link></h6>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="feature-block-two col-md-6 wow fadeInUp" data-wow-delay="200ms">
                      <div className="inner-box">
                        ...
                        <div className="content">
                          <h6 className="title"><Link href="page-services">Count on a <br/> bankable partner.</Link></h6>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="feature-block-two col-md-6 wow fadeInUp" data-wow-delay="300ms">
                      <div className="inner-box">
                        ...
                        <div className="content">
                          <h6 className="title"><Link href="page-services">Optimized design <br/> for your site.</Link></h6>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="feature-block-two col-md-6 wow fadeInUp" data-wow-delay="400ms">
                      <div className="inner-box">
                        ...
                        <div className="content">
                          <h6 className="title"><Link href="page-services">Boost efficiency with TrinaTracker.</Link></h6>
                        </div>
                      </div>
                    </div>
                  </div>
