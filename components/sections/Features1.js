            ...
            <div className="row g-0">
              ...
              <div className="video-column col-lg-4 col-md-12">
                <div className="video-box wow fadeInUp">
                  <figure className="image"><img src="/images/resource/feature1-1.jpg" alt=""/></figure>
                ...
                <div className="inner-column">
                  ...
                  <div className="row g-0">
                    ...
                    <div className="feature-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
                      <div className="inner-box">
                        <div className="image-box">
                          <figure className="image"><Link href="page-services-details"><img src="/images/resource/feature1-2.jpg" alt=""/></Link></figure>
                          <div className="content-box">
                            <h4 className="title"><Link href="page-services-details">Residential <br/>  Solutions</Link></h4>
                            <Link href="page-services-details" className="theme-btn read-more"><i className="fa fa-plus"></i></Link>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="feature-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms">
                      <div className="inner-box">
                        <div className="image-box">
                          <figure className="image"><Link href="page-services-details"><img src="/images/resource/feature1-3.jpg" alt=""/></Link></figure>
                          <div className="content-box">
                            <h4 className="title"><Link href="page-services-details">Commercial <br/>Solutions</Link></h4>
                            <Link href="page-services-details" className="theme-btn read-more"><i className="fa fa-plus"></i></Link>
                          </div>
                        </div>
                      </div>
