...
const Projects2 = () => {
  return (
    <>
      <section className="project-section-two pt-0 mt-8">
          ...
          <div className="outer-box">
            ...
            <div className="fact-counter">
              ...
              <div className="row">
                ...
                <div
                  className="counter-block-two col-xl-4 col-lg-4 col-md-6 col-sm-12 wow fadeInUp"
                ...
                <div className="image-box">
                  <figure className="image">
                    <Link href="page-project-details">
                      <img src="images/resource/project1-1.jpg" alt="Image" />
                    </Link>
                  </figure>
                </div>
            ...
            <SwiperSlide className="project-block">
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image">
                    <Link href="page-project-details">
                      <img src="images/resource/project1-2.jpg" alt="Image" />
                    </Link>
                  </figure>
                </div>
                <div className="content-box">
                  <h1 className="float-text">Wind</h1>
                  <span className="cat"> Sustech Neo Energy Private Ltd.</span>
                  <br />
                  <h4 className="title">Power project</h4>
                  <br />
            ...
            <SwiperSlide className="project-block">
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image">
                    <Link href="page-project-details">
                      <img src="images/resource/project1-3.jpg" alt="Image" />
                    </Link>
                  </figure>
                </div>
                <div className="content-box">
                  <h1 className="float-text">Hydroelectric</h1>
                  <span className="cat"> Sustech Neo Energy Private Ltd.</span>
                  <br />
                  <h4 className="title">Power project</h4>
                  <br />
