        ...
        <div className="auto-container">
          <div className="row">
              ...
              <div className="inner-column">
                <div className="sec-title light">
                  ...
                  <h2 className="letters-slide-up text-split">
                    A global leader <br /> in solar installation
                  </h2>
                  <div className="text">
                    With over four decades of experience providing solutions to
                    large-scale enterprises throughout the globe,.
                  </div>
                </div>
            ...
            <div className="image-column col-lg-6 col-md-12 col-sm-12">
              <div className="inner-column">
                <figure
                  className="image overlay-anim bg-parallax"
                  style={{
                    backgroundImage: "url(images/resource/choose2-1.jpg)",
                  }}
                >
