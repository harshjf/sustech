                  ...
                  <div className="inner-column">
                    ...
                    <div className="bottom-box">
                      ...
                      <div className="author-box">
                        <div className="inner">
                          <div className="author-image"><img src="/images/resource/about1-thumb1.jpg" alt="Image"/></div>
                ...
                <div className="image-column col-xl-7 col-lg-6 col-md-12 col-sm-12">
                  <div className="inner-column">
                    ...
                    <div className="image-box">
                      <div className="image"><img src="/images/resource/about1-1.png" alt="Image"/></div>
                      <div className="image-2 zoom-one" data-wow-delay="300ms"><img src="/images/resource/about1-2.jpg" alt="Image"/></div>
