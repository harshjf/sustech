        ...
        <section className="services-section-two pb-0">
          ...
          <div className="auto-container">
              ...
              <div key={i} className="service-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                <div className="inner-box">
                  <div className="image-box">
                    <figure className="image"><Link href="page-service-details"><img src={`/images/resource/${item.Img}`} alt="Image"/></Link></figure>
                  </div>
            ...
            <div className="bottom-text text-center">
              <div className="text">See more electric services click the button <Link href="page-services">View More Service</Link></div>
            </div>
          </div>
        </section>
        </>
