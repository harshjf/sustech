            ...
            <div className="row">
              ...
              <div className="content-column col-xl-6 col-lg-6 order-lg-2 wow fadeInRight" data-wow-delay="300ms">
                <div className="inner-column">
                  <div className="bg bg-image bg-parallax" style={{ backgroundImage: 'url(images/background/9.jpg)' }}></div>
                    <Swiper {...swiperOptions} className="services-carousel-two owl-carousel owl-theme default-dots">
                        ...
                        <SwiperSlide className="service-block-four">
                            <div className="inner-box">
                              ...
                              <Link href="page-service-details" className="theme-btn btn-style-one bg-orange"><span className="btn-title">Read More<i className="icon-sm-arrow"></i></span></Link>
                            </div>
                        </SwiperSlide>
                        {/* service Block */}
                        <SwiperSlide className="service-block-four">
                    ...
                    <div className="service-block-three col-lg-6 col-md-6 col-sm-12">
                      <div className="inner-box">
                        <div className="content">
                          ...
                          <h6 className="title"><Link href="page-service-details">Commercial <br/>Installation</Link></h6>
                        </div>
                        <Link href="page-service-details" className="theme-btn read-more"><i className="fa fa-plus"></i></Link>
                    ...
                    <div className="service-block-three col-lg-6 col-md-6 col-sm-12">
                      <div className="inner-box">
                        <div className="content">
                          ...
                          <h6 className="title"><Link href="page-service-details">Home <br/>Installation</Link></h6>
                        </div>
                        <Link href="page-service-details" className="theme-btn read-more"><i className="fa fa-plus"></i></Link>
                        <div className="icon-bulb-5"></div>
                      </div>
                    ...
                    <div className="service-block-three col-lg-6 col-md-6 col-sm-12">
                      <div className="inner-box">
                        <div className="content">
                          ...
                          <h6 className="title"><Link href="page-service-details">Repair & <br/>Maintenence</Link></h6>
                        </div>
                        <Link href="page-service-details" className="theme-btn read-more"><i className="fa fa-plus"></i></Link>
                        <div className="icon-bulb-5"></div>
                      </div>
                    ...
                    <div className="service-block-three col-lg-6 col-md-6 col-sm-12">
                      <div className="inner-box">
                        <div className="content">
                          ...
                          <h6 className="title"><Link href="page-service-details">Energy <br/>Powerment</Link></h6>
                        </div>
                        <Link href="page-service-details" className="theme-btn read-more"><i className="fa fa-plus"></i></Link>
                        <div className="icon-bulb-5"></div>
                      </div>
