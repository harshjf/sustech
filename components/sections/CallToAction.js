          ...
          <div className="row">
            <div className="image-column col-xl-8 col-lg-8 col-md-12 col-sm-12">
              <div className="inner-column">
                ...
                <figure className="image-2 wow zoomIn bounce-x">
                  <img src="/images/resource/cta1-2.png" alt="Image" />
                </figure>
                <div className="info-box wow fadeInUp">
                  <h2 className="count">
                    235,099 <span>KWH</span>
                  </h2>
            ...
            <div
              className="content-column col-xl-4 col-lg-4 col-md-12 col-sm-12 wow fadeInRight"
              data-wow-delay="300ms"
            >
              <div className="inner-column">
                <div className="contact-info-block">
                  <figure className="image">
                    <img src="/images/resource/cta1-3.jpg" alt="Image" />
                  </figure>
                  <div className="contact">
                    <h2 className="text">Call us for any inquiry</h2>
                    <Link href="01061245741" className="number">
                      (+91) 98259 35445
                    </Link>
