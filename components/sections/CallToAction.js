            ...
            <div className="row">
              ...
              <div className="image-column col-xl-8 col-lg-8 col-md-12 col-sm-12">
                <div className="inner-column">
                  <figure className="image wow zoomIn"><img src="/images/resource/cta1-1.png" alt="Image"/></figure>
                  <figure className="image-2 wow zoomIn bounce-x"><img src="/images/resource/cta1-2.png" alt="Image"/></figure>
              ...
              <div className="content-column col-xl-4 col-lg-4 col-md-12 col-sm-12 wow fadeInRight" data-wow-delay="300ms">
                <div className="inner-column">
                  <div className="contact-info-block">
                    <figure className="image"><img src="/images/resource/cta1-3.jpg" alt="Image"/></figure>
